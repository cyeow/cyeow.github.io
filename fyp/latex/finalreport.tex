...
% A decentralized wastewater treatment network approach encourages wastewater to be treated near to the source for reuse in the same area. This removes the need to transport wastewater over large distances and meets the same goal.
